      ...
      <div className="home">
        ...
        <section className="hero">
          <div className="announce">
            ...
            <p>Introducing Planorama 1.0</p>
          </div>

          <h1>Build beautiful spaces at the speed of thought with Planorama</h1>

          <p className="subtitle">
            Planorama is an AI-first design environment, that helps you visualize, render and ship architectural projects faster than ever.
          </p>
          ...
          <div id="upload" className="upload-shell scroll-mt-24">
